...
// mr_han
    ...
    public void onScanResult(int callbackType, ScanResult result) {;
        BleLog.i("callbackType " + String.valueOf(callbackType));
        BleLog.i("result " + result.toString());
        BluetoothDevice device = result.getDevice();
        ScanRecord recode = result.getScanRecord();
        ...
        message.obj = new BleDevice(device, result.getRssi(), recode.getBytes(), System.currentTimeMillis());
